...
def test_register_app_handlers_wires_paraview_runtime(monkeypatch):
    ...
    handler_registration.register_app_handlers(
        ...
        refresh_available_files=lambda *_: None,
        persist_uploaded_file=lambda *_: None,
        save_paraview_output=lambda **_: None,
        interaction_quality_presets={"high": {"interactive_quality": 95}},
        debug_view=lambda: None,
        call_view_update=lambda: None,
        call_view_update_geometry=lambda: None,
